...
Sharding can be -> each database having the same collections, but having different data
Sharding can also be (but is rare) -> each datatabase holds a specific table, collection
