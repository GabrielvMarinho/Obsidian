...
When programming a solution for pattelar tendon pain, what i have seen John Evans doing it programming isometrics multiple times a day, every day, (these weeks usually are the first weeks of the knee-pain-solving-program), later on some elastic storage (drop jumps) are added, and then regaining strenght in motion by progressive overloading slow strength training, usually getting to less deep position to begin with, like slow quarter squats