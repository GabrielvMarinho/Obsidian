...
1. A transaction is sent to the [[Network]] 
2. Indenpendent validators ([[Nodes]]) compile them in a list of transactions they believe to be true
...
Every one of the [[Nodes]] need access to the whole [[XRP Ledger]] to validate